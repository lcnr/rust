    ...
    I: Interner,
{
    ...
    fn enter_canonical<R>(
        ...
        for &(key, ty) in &input.predefined_opaques_in_body.opaque_types {
            assert_eq!(ecx.delegate.register_hidden_type(key, ty, ecx.origin_span), None);
        }
    ...
    pub(super) fn register_hidden_type(
        &mut self,
        opaque_type_key: ty::OpaqueTypeKey<I>,
        hidden_ty: I::Ty,
    ) -> Option<I::Ty> {
        self.delegate.register_hidden_type(opaque_type_key, hidden_ty, self.origin_span)
    }
